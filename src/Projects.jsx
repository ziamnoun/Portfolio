...
const Project = ({ title, description, technologies, image, repoLink, liveLink, delay }) => {
  ...
  return (
    <animated.div style={props} className="bg-gray-800 rounded-lg p-6 mb-8 shadow-lg transform hover:scale-105 transition-transform duration-500">
      ...
      <div className="flex justify-between">
        <a href={repoLink} target="_blank" rel="noopener noreferrer" className="btn border-2 border-black bg-red-500 text-white px-4 py-2 rounded hover:bg-red-700 transition-colors duration-300">GitHub Repo</a>
        <a href={liveLink} target="_blank" rel="noopener noreferrer" className="btn border-2 border-black bg-green-500 text-white px-4 py-2 rounded hover:bg-green-700 transition-colors duration-300">Live Demo</a>
      </div>
    </animated.div>
  );
};
...
const Projects = () => {
  const projects = [
    ...
    {
      title: "Fine Art",
      description: "Its a art related website. Here you can see many kinds of art, add art, update art, and delete art.",
      technologies: ["HTML", "CSS", "JavaScript", "React", "Node.js", "Express.js", "MongoDB"],
